...
public class DBStudentMessage extends BmobObject {
    ...
    @Generated(hash = 1529351531)
    public DBStudentMessage(long creatTimeAsId, String senderName, String senderUid, String senderXueHao,
                            String senderZhuanYe, String senderXueYuan, String senderShuSheHao, String senderChuangWeiHao,
                            String messageValue, String messageTitle) {
