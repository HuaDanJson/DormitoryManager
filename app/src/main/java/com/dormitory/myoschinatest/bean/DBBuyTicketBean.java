...
public class DBBuyTicketBean {
    @Id(autoincrement = false)
    public long creatTimeAsId;//录入的具体数据的时间作为ID
    @Property(nameInDb = "DBBuyTicketBean")
    public String userName;//用户名
    public String buyerName;//购买者名字
    public String buyerOld;//购买者年龄
    public String buyerTel;//购买者电话
    public String buyerMail;//购买者邮箱
    public String jingdainMing;//景点名字
    public int position;//景点排序中的位置
    @Generated(hash = 875483577)
    public DBBuyTicketBean(long creatTimeAsId, String userName, String buyerName,
            String buyerOld, String buyerTel, String buyerMail, String jingdainMing,
            int position) {
    ...
    @Generated(hash = 1075638866)
    public DBBuyTicketBean() {
    }
