...
/** 
 * DAO for table "DBBUY_TICKET_BEAN".
*/
public class DBBuyTicketBeanDao extends AbstractDao<DBBuyTicketBean, Long> {

    public static final String TABLENAME = "DBBUY_TICKET_BEAN";

    /**
     * Properties of entity DBBuyTicketBean.<br/>
     * Can be used for QueryBuilder and for referencing column names.
     */
    public static class Properties {
        public final static Property CreatTimeAsId = new Property(0, long.class, "creatTimeAsId", true, "_id");
        public final static Property UserName = new Property(1, String.class, "userName", false, "DBBuyTicketBean");
    ...
    public DBBuyTicketBeanDao(DaoConfig config) {
        super(config);
    }
    
    public DBBuyTicketBeanDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DBBUY_TICKET_BEAN\" (" + //
                "\"_id\" INTEGER PRIMARY KEY NOT NULL ," + // 0: creatTimeAsId
                "\"DBBuyTicketBean\" TEXT," + // 1: userName
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DBBUY_TICKET_BEAN\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, DBBuyTicketBean entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, DBBuyTicketBean entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getCreatTimeAsId());
    ...
    @Override
    public DBBuyTicketBean readEntity(Cursor cursor, int offset) {
        DBBuyTicketBean entity = new DBBuyTicketBean( //
    ...
    @Override
    public void readEntity(Cursor cursor, DBBuyTicketBean entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(DBBuyTicketBean entity, long rowId) {
        entity.setCreatTimeAsId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(DBBuyTicketBean entity) {
        if(entity != null) {
    ...
    @Override
    public boolean hasKey(DBBuyTicketBean entity) {
